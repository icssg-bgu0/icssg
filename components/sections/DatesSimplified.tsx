        ...
        <div className="max-w-2xl mx-auto pmec-card bg-white">
          <ul className="space-y-4 text-gray-700">
            <li className="flex flex-col sm:flex-row sm:justify-between pb-3 border-b border-gray-100">
              ...
              <span className="font-bold text-[#337ab7]">01.09.2026</span>
            </li>
            <li className="flex flex-col sm:flex-row sm:justify-between pb-3 border-b border-gray-100">
              <span className="font-medium">Call for Papers Close:</span>
              <span className="font-bold text-[#337ab7]">01.11.2026</span>
            </li>
            <li className="flex flex-col sm:flex-row sm:justify-between pb-3 border-b border-gray-100">
            ...
            <li className="flex flex-col sm:flex-row sm:justify-between pb-3 border-b border-gray-100">
              <span className="font-medium">Tentative Submission of Revised Paper Deadline:</span>
              <span className="font-bold text-[#337ab7]">14.01.2027</span>
            </li>
            <li className="flex flex-col sm:flex-row sm:justify-between pb-3 border-b border-gray-100">
              <span className="font-medium">Tentative Registration Deadline:</span>
