...
const committeeData: Category[] = [
  {
    title: "Patron",
    members: [
      { name: "Prof. Kulbhusan Balooni", desc: "Vice Chancellor, Birla Global University, Bhubaneswar, Odisha, India" }
    ]
  },
  {
    title: "General Chair",
    members: [
      { name: "Dr. Bibhudatta Sahoo", desc: "Professor, Computer Science and Engineering, National Institute of Technology, Rourkela, Odisha, India" }
    ]
  },
  {
    title: "Program Chair",
    members: [
      { name: "Dr. Srinivas Sethi", desc: "Professor, Indira Gandhi Institute of Technology Sarang, Odisha, India" },
      { name: "Dr. Sanjay Kumar Kuanar", desc: "Dean, School of Applied Science and Engineering & Technology, Birla Global University, Bhubaneswar, Odisha, India" },
      { name: "Dr. Mufti Mahmud", desc: "Professor, King Fahd University of Petroleum and Minerals, Saudi Arabia" }
    ]
  },
  {
    title: "Conveners",
    members: [
      { name: "Dr. Ramesh Kumar Sahoo", desc: "School of Engineering and Technology, Birla Global University,, Bhubaneswar, Odisha, India" },
      { name: "Dr. Indrajeet Kumar", desc: "School of Engineering and Technology, Birla Global University, Bhubaneswar, Odisha, India" },
      { name: "Dr. Bandita Sahu", desc: "School of Applied Science & School of Engineering & Technology, Birla Global University, Bhubaneswar, Odisha, India" }
    ]
  },
  {
    ...
    members: [
      ...
      { name: "Dr. Ashima Rout", desc: "IGIT Sarang" },
  ...
  },
  {
    ...
    members: [
      { name: "Prof. Archana Choudhary", desc: "School of Management, BGU Bhubaneswar" },
      { name: "Dr. Suman Kumar Das", desc: "Indian Institute of Management Jammu" },
      ...
      { name: "Dr. Brojo Kishore Mishra", desc: "Professor, NIST Berhampur" },
      { name: "Dr. Raghvendra Kumar", desc: "Professor, GIET University Gunupur" },
      { name: "Dr. Debabrata Donsena", desc: "Rajendra University Bolangir" },
      ...
      { name: "Dr. Poonam Sahoo", desc: "School of Management, BGU Bhubaneswar" }
    ]
  },
  {
    ...
    members: [
      ...
      { name: "Mr. Prithivi Raj", desc: "School of Law, BGU, Bhubaneswar" }
    ]
  },
  {
    ...
    members: [
      ...
      { name: "Mr. Yogendra Singh", desc: "School of Law, BGU Bhubaneswar" }
    ]
  },
  {
    ...
    members: [
      ...
      { name: "Ms. Ashna Siddiqui", desc: "School of Law, BGU Bhubaneswar" },
  ...
  },
  {
    ...
    members: [
      ...
      { name: "Dr. Shiv Shankar Das", desc: "Dean, School of Communication, BGU Bhubaneswar" },
  ...
  },
  {
    ...
    members: [
      ...
      { name: "Prof. Deepak Tosh", desc: "Computer Science, University of Texas at El Paso" },
      { name: "Prof. Soroj Kumar Meher", desc: "ISI, Bangalore, India" },
      { name: "Prof. Manas Ranjan Patra", desc: "NIST University, Berhampur, India" },
      { name: "Prof. Amit Kumar Mishra", desc: "Aberystwyth University, UK" },
      ...
      { name: "Prof. Gheorghita (George) Ghinea", desc: "Computer Science, Brunel University" },
      ...
      { name: "Dr. Suman Kumar Das", desc: "Indian Institute of Management Jammu" },
      { name: "Dr. Badrinarayan Prusty", desc: "IIT Jammu" },
      ...
      { name: "Prof. Prafulla Kumar Behera", desc: "Utkal University, Bhubaneswar, Odisha, India" },
      ...
      { name: "Prof. Bunil Balabantaray", desc: "NIT, Raipur, India" },
      ...
      { name: "Dr. Anup Maharana", desc: "Rennes school of business, France" },
      ...
      { name: "Dr. Priyabrata Sahu", desc: "IGIT Sarang, India" },
      { name: "Prof. Biswanath Sethi", desc: "IGIT, Sarang, India" },
      { name: "Prof. Niroj Pani", desc: "IGIT, Sarang, India" },
      { name: "Dr. Sujit Kumar Pradhan", desc: "IGIT, Sarang, India" },
      { name: "Dr. Janmejaya Rout", desc: "IGIT, Sarang, India" },
      { name: "Dr. Amulya Bihari Pattnaik", desc: "IGIT, Sarang, India" },
      { name: "Dr. Taraprasanna Das", desc: "IGIT, Sarang, India" },
      { name: "Dr. Satya Bhuyan", desc: "IGIT, Sarang, India" },
      ...
      { name: "Prof. Babita Majhi", desc: "GGU, Chhatisgarh, India" },
      { name: "Prof. Subhrashu Das", desc: "GCE, Keunjhar, India" },
      { name: "Prof. Manoj Kumar Sahu", desc: "Associate Professor, CUPGS, BPUT, Odisha, India" },
      ...
      { name: "Prof. Saroj Kumar Panigrahi", desc: "VIT, Vellore, India" },
      ...
      { name: "Dr. Arun Kumar", desc: "NIT Rourkela" },
      { name: "Dr. Alekh Mishra", desc: "NIT Jamshedpur" },
      { name: "Dr. Anjali Gautam", desc: "IIIT Allahabad, India" }
    ]
  }
];
